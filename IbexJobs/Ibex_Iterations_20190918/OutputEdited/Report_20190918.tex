...
\centering
\subfigure
{\includegraphics[scale=.4]{dailyCostComparison.eps}}\quad
{\includegraphics[scale=.4]{accumulatedCostComparison.eps}}
...
\IfFileExists{Simulations/Simulation_\arabic{i}\arabic{j}\arabic{k}_ZeroLambdas/120.eps} % DO:
{{\graphicspath{{Simulations/Simulation_\arabic{i}\arabic{j}\arabic{k}_OptimalLambdas/}}
\include{Report_Auxiliary_1}}
{\graphicspath{{Simulations/Real_\arabic{i}\arabic{j}\arabic{k}_ZeroLambdas/}}
\include{Report_Auxiliary_2}}}
{}

\IfFileExists{Simulations/Simulation_\arabic{i}0\arabic{j}\arabic{k}_ZeroLambdas/120.eps} % DO:
{{\graphicspath{{Simulations/Simulation_\arabic{i}0\arabic{j}\arabic{k}_OptimalLambdas/}}
\include{Report_Auxiliary_1}}
{\graphicspath{{Simulations/Real_\arabic{i}0\arabic{j}\arabic{k}_ZeroLambdas/}}
\include{Report_Auxiliary_2}}}
{}

\IfFileExists{Simulations/Simulation_\arabic{i}\arabic{j}0\arabic{k}_ZeroLambdas/120.eps} % DO:
{{\graphicspath{{Simulations/Simulation_\arabic{i}\arabic{j}0\arabic{k}_OptimalLambdas/}}
\include{Report_Auxiliary_1}}
{\graphicspath{{Simulations/Real_\arabic{i}\arabic{j}0\arabic{k}_ZeroLambdas/}}
\include{Report_Auxiliary_2}}}
{}

\IfFileExists{Simulations/Simulation_\arabic{i}0\arabic{j}0\arabic{k}_ZeroLambdas/120.eps} % DO:
{{\graphicspath{{Simulations/Simulation_\arabic{i}0\arabic{j}0\arabic{k}_OptimalLambdas/}}
\include{Report_Auxiliary_1}}
{\graphicspath{{Simulations/Real_\arabic{i}0\arabic{j}0\arabic{k}_ZeroLambdas/}}
\include{Report_Auxiliary_2}}}
{}
