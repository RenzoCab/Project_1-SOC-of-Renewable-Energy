...
%     Lambda32 = Lambda32/1e6; % We pass from USD/hm^3 to USD/m^3.
    ...
    artificialWaterValue = 1; % For debugging.
    ...
    if WhatToDo == 2 || WhatToDo == 3 || WhatToDo == 4 || WhatToDo == 5 || WhatToDo == 6 || WhatToDo == 7
        ...
        if WhatToDo ~= 5
            ...
            for t = 1:length(time)
                ...
                % problem. (16/10/2019: We added waterIzero).
...
%                     accumRealInstantCost(t) = accumRealInstantCost(t-1) + realInstantCost(t); ccc
   ...
   %                 legend('Biomass Power','Solar Power','Wind Power','Salto Grande (Hydro)','Bonete (Hydro)','Baygorria (Hydro)','Palmar (Hydro)',...
    %                    'Motores Batlle (Fossil)','PTA (Fossil)','PTB (Fossil)','CTR (Fossil)','Failure (Fossil)','Demand','Demand + Exp.','location','eastoutside');
                ...
                title('Error GAP (for dual function ONLY)');
                set(gca,'Box','on');
                ...
                grid minor;
                ylabel('USD/Time');
                title('Costs per Time Unit over OP (Virtual Controls)');
...
%                 end
                ...
                dataFrom_6 = {...
                    finalCostHJB,...
                    accumRealInstantCost(end)/NormCost,...
                    Khe1,Khe2,Khe3,Khe4,...
                    IT1(1),IT2(1),IT3(1),IT4(1)
                    };
                save([pwd '/','Simulations/dataFrom_6_',name,'.mat'],'dataFrom_6','-v7.3');
            ...
            elseif WhatToDo == 7
                ...
                save([pwd '/','Simulations/dataFrom_7_',name,'.mat'],'dataFrom_7','-v7.3');
