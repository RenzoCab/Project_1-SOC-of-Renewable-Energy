...
% HamToMin = @(uv4,uv1,phit4,phit1,phif,t,cw,Y_hat) TMax*(hatKh4(uv4)*phit4 + hatKh1(uv1)*phit1 + hatKf*phif + IT4(t)*uv4/VolMax4 + IT1(t)*uv1/VolMax1) + 2*(theta_W(t)*(pW(t)-Y_hat*SigW(t)/2)/SigW(t)-Y_hat*d_SigW(t)/(2*SigW(t)))*(6*cw(1)*Y_hat^5+5*cw(2)*Y_hat^4+4*cw(3)*Y_hat^3+3*cw(4)*Y_hat^2+2*cw(5)*Y_hat+cw(6)) + 2*(theta_W(t)*alpha_W*Y_hat*(1-Y_hat*SigW(t)/2)/SigW(t))*(6*5*cw(1)*Y_hat^4+5*4*cw(2)*Y_hat^3+4*3*cw(3)*Y_hat^2+3*2*cw(4)*Y_hat+2*cw(5));
HamToMin = @(uv4,uv1,phit4,phit1,phif,t,cw,Y_hat) TMax*(hatKh4(uv4)*phit4 + hatKh1(uv1)*phit1 + hatKf*phif + IT4(t)*uv4/VolMax4 + IT1(t)*uv1/VolMax1) + (d_ExW(t)/SigW(t)-Y_hat*(theta_W(t)+d_SigW(t)/(2*SigW(t))))*(6*cw(1)*Y_hat^5+5*cw(2)*Y_hat^4+4*cw(3)*Y_hat^3+3*cw(4)*Y_hat^2+2*cw(5)*Y_hat+cw(6)) + (4*theta_W(t)*alpha_W/(SigW(t)^2))*(Y_hat*SigW(t)/2+pW(t))*(1-Y_hat*SigW(t)/2-pW(t))*(6*5*cw(1)*Y_hat^4+5*4*cw(2)*Y_hat^3+4*3*cw(3)*Y_hat^2+3*2*cw(4)*Y_hat+2*cw(5));
...
HamToMin_W = @(uv4,uv1,phit4,phit1,phif,t,cw,Y_hat) (d_ExW(t)/SigW(t)-Y_hat*(theta_W(t)+d_SigW(t)/(2*SigW(t))))*(6*cw(1)*Y_hat^5+5*cw(2)*Y_hat^4+4*cw(3)*Y_hat^3+3*cw(4)*Y_hat^2+2*cw(5)*Y_hat+cw(6)) + (4*theta_W(t)*alpha_W/(SigW(t)^2))*(Y_hat*SigW(t)/2+pW(t))*(1-Y_hat*SigW(t)/2-pW(t))*(6*5*cw(1)*Y_hat^4+5*4*cw(2)*Y_hat^3+4*3*cw(3)*Y_hat^2+3*2*cw(4)*Y_hat+2*cw(5));

% HamToMin_HF = @(uv4,uv1,phit4,phit1,phif,t,cw,Y_hat) TMax*(hatKh4(uv4)*phit4 + hatKh1(uv1)*phit1 + hatKf*phif + IT4(t)*uv4/VolMax4 + IT1(t)*uv1/VolMax1);
% HamToMin_W = @(uv4,uv1,phit4,phit1,phif,t,cw,Y_hat) 2*(theta_W(t)*(pW(t)-Y_hat*SigW(t)/2)/SigW(t)-Y_hat*d_SigW(t)/(2*SigW(t)))*(6*cw(1)*Y_hat^5+5*cw(2)*Y_hat^4+4*cw(3)*Y_hat^3+3*cw(4)*Y_hat^2+2*cw(5)*Y_hat+cw(6)) + 2*(theta_W(t)*alpha_W*Y_hat*(1-Y_hat*SigW(t)/2)/SigW(t))*(6*5*cw(1)*Y_hat^4+5*4*cw(2)*Y_hat^3+4*3*cw(3)*Y_hat^2+3*2*cw(4)*Y_hat+2*cw(5));
...
%                 if CinZ1(V1(i),uv1(i,j,w))<0 && CinZ4(V4(j),uv4(i,j,w))<0 && Ph_star1(V1(i),uv1(i,j,w))>0 && Ph_star4(V4(j),uv4(i,j,w))>0 %456
