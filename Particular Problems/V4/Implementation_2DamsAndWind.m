...
D = D01012017'*1000;
DW(1,:) = max(0,D-(ExW-SigW)*GW);
DW(2,:) = max(0,D-ExW*GW);
DW(3,:) = max(0,D-(ExW+SigW)*GW);
...
Ham = @(uv4,uv1,phit4,phit1,phif,t) TMax*(hatKh4(uv4)*phit4 + hatKh1(uv1)*phit1 + hatKf*phif + IT4(t)*uv4/VolMax4 + IT1(t)*uv1/VolMax1);
...
for w=2:3
    ...
    for t=length(time):-1:1
        ...
        for i=1+Reduction:length(V1)-Reduction
            for j=1+Reduction:length(V4)-Reduction
                ...
                if CinZ1(V1(i),uv1(i,j))<0 && CinZ4(V4(j),uv4(i,j))<0 && Ph_star1(V1(i),uv1(i,j))>0 && Ph_star4(V4(j),uv4(i,j))>0
                    ...
                    CinZ1_test_NEG = CinZ1(V1(i),uv1(i,j))
                    CinZ4_test_NEG = CinZ4(V4(j),uv4(i,j))
                    Ph_star1_test_POS = Ph_star1(V1(i),uv1(i,j))
                    Ph_star4_test_POS = Ph_star4(V4(j),uv4(i,j))
                    return;
                end
                ...
                HAM(i,j) = Ham(uv4(i,j),uv1(i,j),PhiT4(t,i,j),PhiT1(t,i,j),PhiF(t,i,j),t);
        ...
        s0 = surf(v1(newStart:end-Reduction,newStart:end-Reduction),v4(newStart:end-Reduction,newStart:end-Reduction),squeeze(u(t,newStart:end-Reduction,newStart:end-Reduction))');
        xlabel('V1');
        ylabel('V4');
        zlabel('US$');
    ...
    %     saveas(gcf,'Result_1','epsc');
        ...
        [v1,v4] = meshgrid(V1,V4);
        s6 = surf(v1(newStart:end-Reduction,newStart:end-Reduction),v4(newStart:end-Reduction,newStart:end-Reduction),squeeze(Pf(t,newStart:end-Reduction,newStart:end-Reduction))');
        xlabel('V1');
        ylabel('V4');
    ...
    %     saveas(gcf,'Result_1','epsc');
        ...
        [v1,v4] = meshgrid(V1,V4);
        s7 = surf(v1(newStart:end-Reduction,newStart:end-Reduction),v4(newStart:end-Reduction,newStart:end-Reduction),squeeze(Ph1(t,newStart:end-Reduction,newStart:end-Reduction))');
        xlabel('V1');
        ylabel('V4');
        title(['Hidraulic Power 1 (time=',num2str(t),')']);
        % ===================== LIMITS ===================== (1,0)
        xlim([Vmin1+dV1*Reduction Vmax1-dV1*Reduction]);
        ylim([Vmin4+dV4*Reduction Vmax4-dV4*Reduction]);
    %     xlim([Vmin1+DV1/10 Vmax1-DV1/10]);
    ...
    %     saveas(gcf,'Result_1','epsc');
        ...
        [v1,v4] = meshgrid(V1,V4);
        s8 = surf(v1(newStart:end-Reduction,newStart:end-Reduction),v4(newStart:end-Reduction,newStart:end-Reduction),squeeze(Ph4(t,newStart:end-Reduction,newStart:end-Reduction))');
        xlabel('V1');
        ylabel('V4');
        title(['Hidraulic Power 4 (time=',num2str(t),')']);
        % ===================== LIMITS ===================== (1,0)
        xlim([Vmin1+dV1*Reduction Vmax1-dV1*Reduction]);
        ylim([Vmin4+dV4*Reduction Vmax4-dV4*Reduction]);
    %     xlim([Vmin1+DV1/10 Vmax1-DV1/10]);
    ...
    %     saveas(gcf,'Result_1','epsc');
        ...
        [v1,v4] = meshgrid(V1,V4);
        s11 = surf(v1(newStart:end-Reduction,newStart:end-Reduction),v4(newStart:end-Reduction,newStart:end-Reduction),HAM(newStart:end-Reduction,newStart:end-Reduction)');
        xlabel('V1');
        ylabel('V4');
