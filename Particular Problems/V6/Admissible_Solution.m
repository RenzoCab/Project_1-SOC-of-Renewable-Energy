function [Uini] = Admissible_Solution(ComputePlots,SavePlots,expansion,UseLamb21,UseLamb32,Lambda21,Lambda32)
                ...
                for v4 = 1:length(V4)
                    ...
                    if UseLamb21 == 1
                        if t > Z21
                            ...
                            ControlsFMC(v1,v3,v4,1:8) = Quad_FMC_Lambda(Q,b(V1(v1),V3(v3),V4(v4)),c(t),...
                                d(uV1(v1,v3,v4),0,uV3(v1,v3,v4),uV4(v1,v3,v4),t),k(t),options,1,0.2,x0);
                        end
                    else % if UseLamb21 == 0
                        ControlsFMC(v1,v3,v4,1:8) = Quad_FMC_Lambda(Q,b(V1(v1),V3(v3),V4(v4)),c(t),...
                    ...
                    elseif t > Z32
                        ...
                        ControlsFMC(v1,v3,v4,9) = 0.2; % Is almost Baygorria at Phi_T = 1.
                    end
