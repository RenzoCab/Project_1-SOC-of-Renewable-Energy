    ...
    if OptimalPath == 1
        ...
        for t = 1:length(time)
            ...
            if t ~= length(time)
                ...
                Vol_OP_3(t+1) = Vol_OP_3(t) + (dt*TMax/VolMax3)*(IT3(t)-Controls_OP(t,6)*FlowMax3+Controls_OP(t,9)*MaxV3);
                Vol_OP_4(t+1) = Vol_OP_4(t) + (dt*TMax/VolMax4)*(IT4(t)-Controls_OP(t,7)*FlowMax4);
