function [Uini] = Cost_Ini_Deterministic_Lambda(ComputePlots,SavePlots,expansion,UseLamb21,UseLamb32,Lambda21,Lambda32)
    ...
    options = optimoptions('fmincon','Display','notify','MaxFunctionEvaluations',10000,...
        'FunctionTolerance',1.0000e-9,'MaxIterations',5000,'MaxFunEvals',10^7,'Algorithm','sqp',...
    ...
    Khe1 = 0.3/10^3; % In Mil USD/MWh. Cost per energy of Bonete.
    Khe2 = 0; % In Mil USD/MWh.
    Khe3 = 0.3/10^3; % In Mil USD/MWh.
    Khe4 = 0.3/10^3; % In Mil USD/MWh.
    Kf = 130/10^3; % In Mil USD/MWh. Cost per energy of the fuel.
