...
\graphicspath{{../../IbexJobs/ibex_lambdas_20191109/Simulations/}}
{\includegraphics[scale=1]{2_DG_20180302.eps}} 

\newcounter{i}
\newcounter{j}

\forloop{i}{1}{\value{i} < 48}{

\include{Report_ibex_lambdas_20191109_aux}
