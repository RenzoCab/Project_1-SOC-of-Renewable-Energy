...
\graphicspath{{../../wsJobs/ws_lambdas_20191113/TEST_Matlab-Python/Optimization_OC_Subgradient_Method_Automatic_EXPERIMENTS/Simulations/}}

\IfFileExists{../../wsJobs/ws_lambdas_20191113/TEST_Matlab-Python/Optimization_OC_Subgradient_Method_Automatic_EXPERIMENTS/Simulations/table_2_\arabic{i}\arabic{j}\arabic{k}.mat} % DO:
{
...
\column{.5\textwidth}
\includegraphics[width=\mysize\textwidth]{DG_2_\arabic{i}0\arabic{j}\arabic{k}.eps}
...
\ifnum \value{k}>9
\IfFileExists{../../wsJobs/ws_lambdas_20191113/TEST_Matlab-Python/Optimization_OC_Subgradient_Method_Automatic_EXPERIMENTS/Simulations/table_2_\arabic{i}0\arabic{j}\arabic{k}.mat} % DO:
{
...
\IfFileExists{../../wsJobs/ws_lambdas_20191113/TEST_Matlab-Python/Optimization_OC_Subgradient_Method_Automatic_EXPERIMENTS/Simulations/table_2_\arabic{i}\arabic{j}0\arabic{k}.mat} % DO:
{
...
\column{.5\textwidth}
\includegraphics[width=\mysize\textwidth]{DG_2_\arabic{i}0\arabic{j}0\arabic{k}.eps}
...
\IfFileExists{../../wsJobs/ws_lambdas_20191113/TEST_Matlab-Python/Optimization_OC_Subgradient_Method_Automatic_EXPERIMENTS/Simulations/table_2_\arabic{i}0\arabic{j}0\arabic{k}.mat} % DO:
{
